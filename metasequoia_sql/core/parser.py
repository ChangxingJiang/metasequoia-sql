...
def parse_case_expression(scanner_or_string: Union[TokenScanner, str]) -> Union[
...
def parse_table_name_expression(scanner_or_string: Union[TokenScanner, str]) -> Union[
    SQLTableNameExpression, SQLSubQueryExpression]:
    """解析表名表达式或子查询表达式
