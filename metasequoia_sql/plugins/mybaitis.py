...
from metasequoia_sql import DataSource
...
from metasequoia_sql.core import SQLParser, SQLGeneralExpression
...
if __name__ == "__main__":
    test_sql = "SELECT shohin_mei FROM Shohin WHERE #{hanbai_tanka} > 500;"
