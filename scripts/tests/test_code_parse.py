...
class TestCoreParser(unittest.TestCase):
    ...
    def test_compare_operator(self):
        ...
        self.assertEqual(SQLParser.parse_compare_operator("= 3").source(DataSource.MYSQL), "=")
        self.assertEqual(SQLParser.parse_compare_operator("< 3").source(DataSource.MYSQL), "<")
        self.assertEqual(SQLParser.parse_compare_operator("<= 3").source(DataSource.MYSQL), "<=")
        self.assertEqual(SQLParser.parse_compare_operator("> 3").source(DataSource.MYSQL), ">")
        self.assertEqual(SQLParser.parse_compare_operator(">= 3").source(DataSource.MYSQL), ">=")
    ...
    def test_compute_operator(self):
        ...
        self.assertEqual(SQLParser.parse_compute_operator("+ 3").source(DataSource.MYSQL), "+")
        self.assertEqual(SQLParser.parse_compute_operator("- 3").source(DataSource.MYSQL), "-")
        self.assertEqual(SQLParser.parse_compute_operator("* 3").source(DataSource.MYSQL), "*")
        self.assertEqual(SQLParser.parse_compute_operator("/ 3").source(DataSource.MYSQL), "/")
        self.assertEqual(SQLParser.parse_compute_operator("% 3").source(DataSource.SQL_SERVER), "%")
        self.assertEqual(SQLParser.parse_compute_operator("|| 'A'").source(DataSource.ORACLE), "||")
    ...
    def test_logical_operator(self):
        ...
        self.assertEqual(SQLParser.parse_logical_operator("AND a > 1").source(DataSource.MYSQL), "AND")
        self.assertEqual(SQLParser.parse_logical_operator("OR a > 1").source(DataSource.MYSQL), "OR")
    ...
    def test_literal_expression(self):
        ...
        self.assertEqual(SQLParser.parse_literal_expression("1 WHERE").source(DataSource.MYSQL), "1")
        self.assertEqual(SQLParser.parse_literal_expression("2.5 WHERE").source(DataSource.MYSQL), "2.5")
        self.assertEqual(SQLParser.parse_literal_expression("'a' WHERE").source(DataSource.MYSQL), "'a'")
        self.assertEqual(SQLParser.parse_literal_expression("x'3f' WHERE").source(DataSource.MYSQL), "x'3F'")
        self.assertEqual(SQLParser.parse_literal_expression("TRUE WHERE").source(DataSource.MYSQL), "TRUE")
        self.assertEqual(SQLParser.parse_literal_expression("true WHERE").source(DataSource.MYSQL), "TRUE")
        self.assertEqual(SQLParser.parse_literal_expression("False WHERE").source(DataSource.MYSQL), "FALSE")
        self.assertEqual(SQLParser.parse_literal_expression("b'1' WHERE").source(DataSource.MYSQL), "b'1'")
        self.assertEqual(SQLParser.parse_literal_expression("null WHERE").source(DataSource.MYSQL), "NULL")
        self.assertEqual(SQLParser.parse_literal_expression("NULL WHERE").source(DataSource.MYSQL), "NULL")
    ...
    def test_wildcard_expression(self):
        ...
        self.assertEqual(SQLParser.parse_wildcard_expression("*").source(DataSource.MYSQL), "*")
        self.assertEqual(SQLParser.parse_wildcard_expression("t1.*").source(DataSource.MYSQL), "t1.*")
    ...
    def test_table_name_expression(self):
        """测试解析报名表达式"""
        self.assertEqual(SQLParser.parse_table_name_expression("table1.column1 AS t1").source(DataSource.MYSQL), "table1.column1")
    ...
    def test_alias_expression(self):
        ...
        self.assertEqual(SQLParser.parse_alias_expression("t1").source(DataSource.MYSQL), "AS t1")
        self.assertEqual(SQLParser.parse_alias_expression("AS t1").source(DataSource.MYSQL), "AS t1")

    def test_join_expression(self):
        """测试解析关联表达式"""
        self.assertEqual(SQLParser.parse_join_expression("ON t1.column1 = t2.column2").source(DataSource.MYSQL),
                         "ON t1.column1 = t2.column2")
        self.assertEqual(SQLParser.parse_join_expression("USING(column1, column2)").source(DataSource.MYSQL),
    ...
    def test_table_expression(self):
        """测试解析表表达式"""
        self.assertEquals(SQLParser.parse_table_expression("schema1.table1 AS t1").source(DataSource.MYSQL),
    ...
    def test_select_clause(self):
        ...
        self.assertEqual(
            SQLParser.parse_select_clause("SELECT column1 AS c1, TRIM(column2) AS c2 FROM table1").source(DataSource.MYSQL),
            "SELECT column1 AS c1, TRIM(column2) AS c2")
        self.assertEqual(SQLParser.parse_select_clause("SELECT column1 AS c1").source(DataSource.MYSQL), "SELECT column1 AS c1")
    ...
    def test_join_clause(self):
        ...
        self.assertEqual(
            SQLParser.parse_join_clause("LEFT JOIN table2 AS t2 ON t1.column1 = t2.column1").source(DataSource.MYSQL),
            "LEFT JOIN table2 AS t2 ON t1.column1 = t2.column1")
        self.assertEqual(
            SQLParser.parse_join_clause("LEFT JOIN schema2.table2 AS t2 ON t1.column1 = t2.column1").source(DataSource.MYSQL),
    ...
    def test_where_clause(self):
        ...
        self.assertEqual(SQLParser.parse_where_clause("WHERE column1 > 3 AND column2 > 2").source(DataSource.MYSQL),
                         "WHERE column1 > 3 AND column2 > 2")
        self.assertEqual(SQLParser.parse_where_clause("WHERE column1 > 3 OR column2 > 2").source(DataSource.MYSQL),
                         "WHERE column1 > 3 OR column2 > 2")
        self.assertEqual(SQLParser.parse_where_clause("WHERE column1 > 3 OR column2 BETWEEN 2 AND 4").source(DataSource.MYSQL),
    ...
    def test_group_by_clause(self):
        ...
        self.assertEqual(SQLParser.parse_group_by_clause("GROUP BY column1, column2").source(DataSource.MYSQL),
                         "GROUP BY column1, column2")
        self.assertEqual(SQLParser.parse_group_by_clause("GROUP BY trim(column1), column2").source(DataSource.MYSQL),
    ...
    def test_having_clause(self):
        ...
        self.assertEqual(SQLParser.parse_having_clause("HAVING column1 > 3 AND column2 > 2").source(DataSource.MYSQL),
                         "HAVING column1 > 3 AND column2 > 2")
        self.assertEqual(SQLParser.parse_having_clause("HAVING column1 > 3 OR column2 > 2").source(DataSource.MYSQL),
                         "HAVING column1 > 3 OR column2 > 2")
        self.assertEqual(SQLParser.parse_having_clause("HAVING column1 > 3 OR column2 BETWEEN 2 AND 4").source(DataSource.MYSQL),
    ...
    def test_order_by_clause(self):
        ...
        self.assertEqual(SQLParser.parse_order_by_clause("ORDER BY column1, column2").source(DataSource.MYSQL),
                         "ORDER BY column1, column2")
        self.assertEqual(SQLParser.parse_order_by_clause("ORDER BY column1, column2 DESC").source(DataSource.MYSQL),
                         "ORDER BY column1, column2 DESC")
        self.assertEqual(SQLParser.parse_order_by_clause("ORDER BY trim(column1) ASC, column2").source(DataSource.MYSQL),
    ...
    def test_limit_clause(self):
        ...
        self.assertEqual(SQLParser.parse_limit_clause("LIMIT 2, 5").source(DataSource.MYSQL), "LIMIT 2, 5")
        self.assertEqual(SQLParser.parse_limit_clause("LIMIT 5 OFFSET 2").source(DataSource.MYSQL), "LIMIT 2, 5")
