...
from metasequoia_sql.analyzer import GetCurrentUsedQuoteColumns, SourceColumn
from metasequoia_sql.common import ordered_distinct


def format_source_column_list(columns: List[SourceColumn]) -> List[str]:
    return ordered_distinct([column.source() for column in columns])


def get_used_column_list(statement: SQLStatement) -> List[str]:
    return format_source_column_list(GetCurrentUsedQuoteColumns.handle(statement))
...
class TestSqlBasicTutorial(unittest.TestCase):
    def test_sbt_ch02_01(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_id", "shohin_mei", "shiire_tanka"])
    ...
    def test_sbt_ch02_02(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["*"])
    ...
    def test_sbt_ch02_03(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_id", "shohin_mei", "shohin_bunrui", "hanbai_tanka", "shiire_tanka", "torokubi"])
    ...
    def test_sbt_ch02_06(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_id", "shohin_mei"])
    ...
    def test_sbt_ch02_07(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_bunrui"])
    ...
    def test_sbt_ch02_08(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shiire_tanka"])
    ...
    def test_sbt_ch02_09(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_bunrui", "torokubi"])
    ...
    def test_sbt_ch02_10(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "shohin_bunrui"])
    ...
    def test_sbt_ch02_13(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_id", "shiire_tanka"])
    ...
    def test_sbt_ch02_17(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "hanbai_tanka"])
    ...
    def test_sbt_ch02_18(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "shohin_bunrui", "hanbai_tanka"])
    ...
    def test_sbt_ch02_21(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "shohin_bunrui", "torokubi"])
    ...
    def test_sbt_ch02_22(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "hanbai_tanka", "shiire_tanka"])
    ...
    def test_sbt_ch02_24(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["chr"])
    ...
    def test_sbt_ch02_25(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "shiire_tanka"])
    ...
    def test_sbt_ch02_33(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "shiire_tanka", "shohin_bunrui", "hanbai_tanka"])
    ...
    def test_sbt_ch03_04(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["hanbai_tanka"])
    ...
    def test_sbt_ch03_05(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["hanbai_tanka", "shiire_tanka"])
    ...
    def test_sbt_ch03_09(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["torokubi"])
    ...
    def test_sbt_ch03_15(self):
        ...
        self.assertEqual(statement.get_where_used_column_list(), ["shohin_bunrui"])
        self.assertEqual(statement.get_group_by_used_column_list(), ["shiire_tanka"])
        self.assertEqual(get_used_column_list(statement), ["shiire_tanka", "*", "shohin_bunrui"])
    ...
    def test_sbt_ch03_22(self):
        ...
        self.assertEqual(statement.get_group_by_used_column_list(), ["shohin_bunrui"])
        self.assertEqual(get_used_column_list(statement), ["shohin_bunrui", "hanbai_tanka"])
    ...
    def test_sbt_ch03_24(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_bunrui", "*", "shohin_mei"])
    ...
    def test_sbt_ch03_27(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_id", "shohin_mei", "hanbai_tanka", "shiire_tanka"])
    ...
    def test_sbt_ch03_33(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "hanbai_tanka", "shiire_tanka", "shohin_id"])
    ...
    def test_sbt_ch05_01(self):
        ...
        self.assertEqual(statement.get_group_by_used_column_list(), ["shohin_bunrui"])
        self.assertEqual(get_used_column_list(statement), ["shohin_bunrui", "hanbai_tanka", "shiire_tanka"])
    ...
    def test_sbt_ch05_03(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_bunrui", "cnt_shohin"])
    ...
    def test_sbt_ch05_12(self):
        ...
        self.assertEqual(statement.get_where_used_column_list(), ["hanbai_tanka"])
        self.assertEqual(get_used_column_list(statement), ["shohin_id", "shohin_mei", "hanbai_tanka"])
    ...
    def test_sbt_ch05_15(self):
        ...
        self.assertEqual(statement.get_select_used_column_list(), ["hanbai_tanka"])
        self.assertEqual(statement.get_group_by_used_column_list(), ["shohin_bunrui"])
        self.assertEqual(get_used_column_list(statement), ["hanbai_tanka", "shohin_bunrui"])
    ...
    def test_sbt_ch05_16_oracle(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_bunrui", "shohin_mei", "hanbai_tanka", "S1.shohin_bunrui", "S2.shohin_bunrui"])
    ...
    def test_sbt_ch06_02(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["m"])
    ...
    def test_sbt_ch06_03_oracle(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["n", "p"])
    ...
    def test_sbt_ch06_04(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["m", "n"])
    ...
    def test_sbt_ch06_06_mysql(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["str1", "str2"])
    ...
    def test_sbt_ch06_07_mysql(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["str1", "str2", "str3"])
    ...
    def test_sbt_ch06_08_oracle(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["str1"])
    ...
    def test_sbt_ch06_16_sqlserver(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["YEAR", "MONTH", "DAY", "HOUR", "MINUTE", "SECOND"])
    ...
    def test_sbt_ch06_20(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["str2"])
    ...
    def test_sbt_ch06_22(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["*", "strcol"])
    ...
    def test_sbt_ch06_36(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "hanbai_tanka", "shohin_id", "tenpo_id"])
    ...
    def test_sbt_ch06_38_oracle(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_mei", "hanbai_tanka", "*", "TS.tenpo_id", "TS.shohin_id", "S.shohin_id"])
    ...
    def test_sbt_ch07_04(self):
        ...
        self.assertEqual(statement.get_where_used_column_list(), ["shohin_bunrui"])
        self.assertEqual(statement.get_order_by_used_column_list(), ["shohin_id"])
        self.assertEqual(get_used_column_list(statement), ["shohin_id", "shohin_mei", "shohin_bunrui"])
    ...
    def test_sbt_ch07_09_oracle(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["TS.tenpo_id", "TS.tenpo_mei", "TS.shohin_id", "S.shohin_mei", "S.hanbai_tanka"])
    ...
    def test_sbt_ch07_11_oracle(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["TS.tenpo_id", "TS.tenpo_mei", "S.shohin_id", "S.shohin_mei", "S.hanbai_tanka"])
    ...
    def test_sbt_ch07_14_oracle(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["TS.tenpo_id", "TS.tenpo_mei", "TS.shohin_id", "S.shohin_mei", "S.hanbai_tanka", "ZS.zaiko_suryo", "ZS.souko_id"])
    ...
    def test_sbt_ch07_15_oracle(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["TS.tenpo_id", "TS.tenpo_mei", "TS.shohin_id", "S.shohin_mei"])
    ...
    def test_sbt_ch07_16(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["TS.tenpo_id", "TS.tenpo_mei", "TS.shohin_id", "S.shohin_mei", "S.hanbai_tanka", "S.shohin_id"])
    ...
    def test_sbt_ch07_b(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["emp", "skill", "ES1.emp", "ES2.emp"])
    ...
    def test_sbt_ch08_13(self):
        ...
        self.assertEqual(get_used_column_list(statement), ["shohin_bunrui", "torokubi", "hanbai_tanka"])
