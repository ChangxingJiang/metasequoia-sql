...
class TestSqlBasicTutorial(unittest.TestCase):
    ...
    def test_sbt_ch02_03(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual({"shohin_id": ["shohin_id"], "shohin_mei": ["shohin_mei"], "shohin_bunrui": ["shohin_bunrui"],
                          "hanbai_tanka": ["hanbai_tanka"], "shiire_tanka": ["shiire_tanka"], "torokubi": ["torokubi"]},
                         format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch02_05(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual(
            {"\"商品编号\"": ["shohin_id"], "\"商品名称\"": ["shohin_mei"], "\"进货单价\"": ["shiire_tanka"]},
            format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch02_06(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual(
            {"mojiretsu": [], "kazu": [], "hizuke": [], "shohin_id": ["shohin_id"], "shohin_mei": ["shohin_mei"]},
            format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch02_17(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual(
            {"shohin_mei": ["shohin_mei"], "hanbai_tanka": ["hanbai_tanka"], "\"hanbai_tanka_x2\"": ["hanbai_tanka"]},
            format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch02_20(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual(
            {"shohin_mei": ["shohin_mei"], "shohin_bunrui": ["shohin_bunrui"], "hanbai_tanka": ["hanbai_tanka"]},
            format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch02_22(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual(
            {"shohin_mei": ["shohin_mei"], "hanbai_tanka": ["hanbai_tanka"], "shiire_tanka": ["shiire_tanka"]},
            format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch03_32(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual({"id": ["shohin_id"], "shohin_mei": ["shohin_mei"], "ht": ["hanbai_tanka"],
                          "shiire_tanka": ["shiire_tanka"]},
                         format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch05_16_oracle(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual(
            {"shohin_bunrui": ["shohin_bunrui"], "shohin_mei": ["shohin_mei"], "hanbai_tanka": ["hanbai_tanka"]},
            format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch06_16_db2(self):
        ...
        self.assertEqual(["SYSIBM.SYSDUMMY1"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual(
            {"CURRENT_TIMESTAMP": [], "year": ["YEAR"], "month": ["MONTH"], "day": ["DAY"], "hour": ["HOUR"],
    ...
    def test_sbt_ch06_43(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual({"sum_tanka_ihuku": ["shohin_bunrui", "hanbai_tanka"],
                          "sum_tanka_kitchen": ["shohin_bunrui", "hanbai_tanka"],
                          "sum_tanka_jimu": ["shohin_bunrui", "hanbai_tanka"]},
                         format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch07_09_oracle(self):
        ...
        self.assertEqual(
            ["TS.tenpo_id", "TS.tenpo_mei", "TS.shohin_id", "S.shohin_mei", "S.hanbai_tanka", "S.shohin_id"],
            format_rule_1(CurrentUsedQuoteColumn.handle(statement)))
        ...
        self.assertEqual({"tenpo_id": ["TS.tenpo_id"], "tenpo_mei": ["TS.tenpo_mei"], "shohin_id": ["TS.shohin_id"],
                          "shohin_mei": ["S.shohin_mei"], "hanbai_tanka": ["S.hanbai_tanka"]},
                         format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch07_11_oracle(self):
        ...
        self.assertEqual(
            ["TS.tenpo_id", "TS.tenpo_mei", "S.shohin_id", "S.shohin_mei", "S.hanbai_tanka", "TS.shohin_id"],
            format_rule_1(CurrentUsedQuoteColumn.handle(statement)))
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllJoinClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual({"tenpo_id": ["TS.tenpo_id"], "tenpo_mei": ["TS.tenpo_mei"], "shohin_id": ["S.shohin_id"],
                          "shohin_mei": ["S.shohin_mei"], "hanbai_tanka": ["S.hanbai_tanka"]},
                         format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch07_14_oracle(self):
        ...
        self.assertEqual(
            ["TS.tenpo_id", "TS.tenpo_mei", "TS.shohin_id", "S.shohin_mei", "S.hanbai_tanka", "ZS.zaiko_suryo",
             "S.shohin_id", "ZS.shohin_id", "ZS.souko_id"],
            format_rule_1(CurrentUsedQuoteColumn.handle(statement)))
        self.assertEqual(
            ["TS.tenpo_id", "TS.tenpo_mei", "TS.shohin_id", "S.shohin_mei", "S.hanbai_tanka", "ZS.zaiko_suryo"],
            format_rule_1(CurrentSelectClauseUsedQuoteColumn.handle(statement)))
    ...
    def test_sbt_ch08_01(self):
        ...
        self.assertEqual(
            {"shohin_mei": ["shohin_mei"], "shohin_bunrui": ["shohin_bunrui"], "hanbai_tanka": ["hanbai_tanka"],
             "ranking": ["shohin_bunrui", "hanbai_tanka"]},
            format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch08_03(self):
        ...
        self.assertEqual(
            {"shohin_mei": ["shohin_mei"], "shohin_bunrui": ["shohin_bunrui"], "hanbai_tanka": ["hanbai_tanka"],
             "ranking": ["hanbai_tanka"], "dense_ranking": ["hanbai_tanka"], "row_num": ["hanbai_tanka"]},
            format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch08_04(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual({"shohin_id": ["shohin_id"], "shohin_mei": ["shohin_mei"], "hanbai_tanka": ["hanbai_tanka"],
                          "current_sum": ["hanbai_tanka", "shohin_id"]},
                         format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch08_05(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual({"shohin_id": ["shohin_id"], "shohin_mei": ["shohin_mei"], "hanbai_tanka": ["hanbai_tanka"],
                          "current_avg": ["hanbai_tanka", "shohin_id"]},
                         format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
    ...
    def test_sbt_ch08_07(self):
        ...
        self.assertEqual(["Shohin"],
                         format_rule_1(AllFromClauseUsedQuoteColumn.handle(statement)))
        self.assertEqual({"shohin_id": ["shohin_id"], "shohin_mei": ["shohin_mei"], "hanbai_tanka": ["hanbai_tanka"],
                          "moving_avg": ["hanbai_tanka", "shohin_id"]},
                         format_rule_2(CurrentColumnSelectToDirectQuoteHash.handle(statement)))
