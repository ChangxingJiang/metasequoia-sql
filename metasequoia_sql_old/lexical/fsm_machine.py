...
from metasequoia_sql_old.common.basic import preproc_sql
...
from metasequoia_sql_old.lexical.fsm_operation_map import END, FSM_OPERATION_MAP, FSM_OPERATION_MAP_DEFAULT
